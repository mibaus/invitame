...
export default function Features() {
  ...
  return (
    <section id="beneficios" className="py-16 md:py-24 lg:py-32 px-6 md:px-12 bg-cloud">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-7 reveal">
            <div className="bg-charcoal/[0.02] p-6 md:p-12 rounded-[2.5rem] border border-charcoal/5 group transition-all duration-700 hover:bg-white hover:shadow-2xl">
              <div className="relative rounded-xl overflow-hidden shadow-sm border border-charcoal/5 aspect-[4/3]">
                <img 
                  src="https://images.unsplash.com/photo-1666305132656-097bd699e023?q=80&w=1200&auto=format&fit=crop" 
                  alt="Mujeres usando laptop para planificar boda" 
