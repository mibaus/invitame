...
import { MonogramLayout } from './MonogramLayout';
import { LegacyEditLayout } from './LegacyEdit';
...
export function MasterLayout({ invitation, preview }: MasterLayoutProps) {
    ...
    switch (skin_id) {
        ...
        case 'the-monogram-edit':
            return <MonogramLayout invitation={invitation} preview={preview} />;
        case 'legacy-editorial':
            return <LegacyEditLayout invitation={invitation} preview={preview} />;
        // case 'bolt-dark':
        default:
