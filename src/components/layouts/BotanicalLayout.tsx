...
function GallerySection({ content }: { content: InvitationSchema['content'] }) {
  ...
  const photos = content.gallery_images?.length ? content.gallery_images : ['https://images.unsplash.com/photo-1519741497674-611481863552?q=80&w=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1537633552985-df8429e8048b?q=80&w=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?q=80&w=800&auto=format&fit=crop', 'https://images.unsplash.com/photo-1522673607200-1648832cee98?q=80&w=800&auto=format&fit=crop'];
...
function Footer({ content }: { content: InvitationSchema['content'] }) {
  ...
  return (
    <footer className="pt-20 pb-10 px-6 md:px-12" style={{ backgroundColor: COLORS.mossDark }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-12 pb-16 border-b border-white/5">
          <div className="space-y-6">
            <span className="text-2xl font-serif font-bold tracking-tighter" style={{ color: COLORS.paper, fontFamily: "'Playfair Display', serif" }}>VOWS<span style={{ color: '#a27b5c' }}>.</span></span>
            <p className="text-xs uppercase tracking-[0.3em] font-light max-w-xs leading-relaxed" style={{ color: COLORS.paper, fontFamily: "'Crimson Text', serif" }}>
          ...
          <div className="flex flex-wrap gap-10 md:gap-16">
            <div className="space-y-4">
               <p className="text-[9px] uppercase tracking-[0.4em] font-bold" style={{ color: '#a27b5c', fontFamily: "'Crimson Text', serif" }}>Contacto</p>
               <a href="mailto:hola@vows.ar" className="block text-sm hover:text-white transition-colors" style={{ color: COLORS.paper }}>hola@vows.ar</a>
               <a href="https://wa.me/5491100000000" className="block text-sm hover:text-white transition-colors" style={{ color: COLORS.paper }}>WhatsApp Concierge</a>
            </div>
            <div className="space-y-4">
               <p className="text-[9px] uppercase tracking-[0.4em] font-bold" style={{ color: '#a27b5c', fontFamily: "'Crimson Text', serif" }}>Social</p>
               <a href="#" className="flex items-center gap-2 text-sm hover:text-white transition-colors group" style={{ color: COLORS.paper }}>
        ...
        <div className="mt-10 flex flex-col md:flex-row justify-between items-center gap-6">
           <p className="text-[10px] uppercase tracking-[0.2em]" style={{ color: 'rgba(237, 232, 208, 0.2)' }}>
             © {new Date().getFullYear()} VOWS. Todos los derechos reservados.
           </p>
           <div className="flex gap-8">
              <a href="#" className="text-[10px] uppercase tracking-[0.2em] hover:text-white transition-colors" style={{ color: COLORS.paper }}>Privacidad</a>
              <a href="#" className="text-[10px] uppercase tracking-[0.2em] hover:text-white transition-colors" style={{ color: COLORS.paper }}>Términos</a>
           </div>
        </div>
      </div>
    </footer>
