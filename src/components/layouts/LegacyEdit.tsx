...
function GallerySection({ content }: { content: InvitationSchema['content'] }) {
  const photos = content.gallery_images?.length
    ...
    : [
        ...
        'https://images.unsplash.com/photo-1537633552985-df8429e8048b?q=80&w=600&h=800&auto=format&fit=crop',
        ...
        'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?q=80&w=600&h=800&auto=format&fit=crop',
      ];
