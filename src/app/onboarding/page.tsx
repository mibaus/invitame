...
export default function OnboardingPage() {
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-4 md:p-8 relative bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <header className="mb-12 text-center fade-in">
        <h1 className="font-serif text-5xl md:text-7xl text-[#2C3333] mb-2 tracking-tight">
          VOWS<span className="italic text-[#A27B5C]">.</span>
        </h1>
      ...
      <footer className="mt-12 text-center text-xs text-[#2C3333]/40 tracking-wider">
        &copy; {new Date().getFullYear()} VOWS.
      </footer>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[#A27B5C] text-white px-5 py-3 rounded-full shadow-xl shadow-[#A27B5C]/20 hover:bg-[#8B6B4F] hover:scale-105 transition-all duration-300 group"
      >
        <span className="hidden md:block text-[10px] uppercase tracking-widest font-bold text-white">
          ¿Dudas? Consultanos
        </span>
