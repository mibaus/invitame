...
const Pricing: React.FC = () => {
  const benefits = [
    ...
    { title: "Atmósfera Musical", desc: "Integración nativa de Playlist de Spotify para tus invitados." }
  ];
            ...
            <div className="lg:col-span-5 flex flex-col items-center justify-center p-8 md:p-12 border border-charcoal/5 rounded-3xl bg-white shadow-[0_20px_50px_rgba(0,0,0,0.05)] space-y-8 lg:sticky lg:top-32">
               <div className="text-center space-y-2">
                  ...
                  <div className="flex items-baseline justify-center gap-1">
                    ...
                    <span className="text-7xl md:text-8xl font-serif text-charcoal tracking-tighter">50.000</span>
                  </div>
