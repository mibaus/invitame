      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center relative z-10">
        ...
        <div className="animate-in-up space-y-7 text-center lg:text-left order-1">
          ...
          <div className="flex flex-col sm:flex-row gap-3.5 justify-center lg:justify-start pt-2">
            ...
            <button className="px-9 py-4 border border-charcoal/10 text-charcoal/80 text-[10px] uppercase tracking-widest font-bold hover:bg-white/50 transition-all flex items-center justify-center gap-2">
